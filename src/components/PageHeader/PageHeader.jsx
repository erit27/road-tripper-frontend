      ...
      <div className="pageHeader__logo">
        <Link to="/">
          <img
            src={mobileLogo}
            alt="not loading"
            className="pageHeader__logo--mobile"
          />
        </Link>
        <Link to="/">
          <img
            src={tabletLogo}
            alt="not loading"
            className="pageHeader__logo--tablet"
          />
        </Link>
      </div>
      <div className="pageHeader__nav">
        <Link to="/">
          ...
          <img
            src={homeIcon}
            alt="home icon"
            className="displayNone__tablet icon__header"
          />
        </Link>
        ...
        {access === "admin" && (
          <Link to="/settings">
            <p className="pageHeader__nav--link displayNone__mobile">
              Settings
            </p>
            <img
              src={settingsIcon}
